 ...
 * @LastEditors: Weidows
 * @LastEditTime: 2020-10-29 00:08:28
...
public class File_Io {
  public static void main(String[] args) {
    ...
    //使用相对路径创建File对象
    File f_4 = new File("src/main/java/twenty/august/stream/File.java");
    ...
    //文件重命名(也可以借此更改文件路径)
    f_1.renameTo(new File("./Java/src/main/java/twenty/august/stream/2.txt"));
    System.out.println(f_1.getName()); //f_1对象指向1.txt,只会输出1.txt
    // 再改回来
    new File("./Java/src/main/java/twenty/august/stream/2.txt")
        .renameTo(new File("./Java/src/main/java/twenty/august/stream/1.txt"));

    //检测文件(夹)是否存在
    File f_5 = new File("./Java/src/main/java/twenty/august/stream/1.txt");
    System.out.println(f_5.exists());

    //新建文件
    File f_6 = new File("./Java/src/main/java/twenty/august/stream/2.txt");
    try {
     ...
     */
    File f_7 = new File("./Java/src/main/java/twenty/august/stream/新建文件夹");
    f_7.mkdir();
    // f_7.mkdirs();

    //.list() 返回String[]
    File f_8 = new File("./Java/src/main/java/twenty/august/stream");
